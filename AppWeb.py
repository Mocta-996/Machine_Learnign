...
global files
# correr el archivo : streamlit run AppWeb.py
# seccion de carga de archivos 
optionType =['csv','xls', 'xlsx','json']
files = st.sidebar.file_uploader("Cargar datos",type=optionType,accept_multiple_files=False)
...
def main():
    ...
    #st.header('Organización de Lenguajes y Compiladores 2')
